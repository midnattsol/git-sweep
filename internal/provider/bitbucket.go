...
func NewBitbucket(info *RepoInfo, username, appPassword string) (*Bitbucket, error) {
	if username == "" {
	...
	if username == "" || appPassword == "" {
		return nil, fmt.Errorf("no Bitbucket credentials found. Set BITBUCKET_USERNAME and BITBUCKET_APP_PASSWORD")
	}
